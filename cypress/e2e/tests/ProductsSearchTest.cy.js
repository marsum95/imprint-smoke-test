    ...
    () => {
        ...
        context('Sorting', () => {
            it(
                ...
                { tags: '@smoke' },
                () => {
                    ProductsSearchPage.sortSearchResultsBy(
                        SORTING_CRITERIA.PRICE_ASC
                    );
            ...
            productCategories.categories.forEach((category) => {
                it(
                    ...
                    () => {
                        ...
                        //Approach 1
                        const productNames =
                            ProductsSearchPage.getAllProductNames();
                        cy.wrap(productNames).should(
                            'include.members',
                            category.products
                        );
