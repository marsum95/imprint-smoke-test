...
class SigninFlowPage extends BasePage{
    ...
    // signin flow
    get uploadPic() { return cy.get('input[type="file"]')}
    get uploadBtn() { return cy.get('button[type="button"]').contains('OK')}
    get displaynameInput() { return cy.get('#displayName')}
    get usernameInput() {return cy.get('#username')}
    get aboutInput() { return cy.get('#about')}
    ...
    userProfilePic(){
        this.uploadPic.selectFile('cypress/fixtures/Sofie.jpg', {force: true})
