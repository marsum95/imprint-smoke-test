...
class MessageChatFlow extends BasePage{


    get message() { return cy.get('.icon-messanger', {timeout : 10000})} //click on Messages icon 
    get viewallMessage() { return cy.get('.ant-list-footer')}
    get clickRudi() {return cy.get('#rudi-logo')}
    get typeChat() {return cy.get('[style="padding-left: 6px; padding-right: 6px; flex: 1 1 auto;"] > .ant-input-affix-wrapper > .ant-input')}
    get clickonSend() { return cy.get('[style="padding-left: 6px; padding-right: 6px; flex: 0 0 45px;"] > .button-create > .ant-btn')}
    ...
    gotoAllMessage(){
        cy.get(':nth-child(1) > .edit-view-post-card > .post-card-header > .ant-row-space-between').should('be.visible')
...
export default new MessageChatFlow